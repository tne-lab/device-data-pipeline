...
data_channel=1; % INPUT DATA CHANNEL HERE ** channel for phase calc, look at data channel on roseplot
...
RawData_ev3=load_open_ephys_binary(closedloopPath_2, 'events',3); %edit to grab 2 as well (STIM)
