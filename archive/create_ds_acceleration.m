function logfile_folder = create_ds_acceleration()
%This function does the *.binary to *.mat conversion of Open Ephys
%recordings and downsamples to 1Hz for accelerometry data.
%
...
% Last updated: 01/26/2022 by J. Whear
   ...
   for j = 1:size(folder_list)
       if ~isempty(strfind(folder_list(j,:), cur_path))
          ...
          % define folder to work in 
           ...
           cur_data.sample_rate = 1; % ds to 1 Hz
